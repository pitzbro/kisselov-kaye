...
To use these stylesheets, rename the files and kisselov with the name of your theme.
...
kisselov-alpha-default-narrow.css  
...
kisselov-alpha-default-normal.css
...
kisselov-alpha-default-wide.css
